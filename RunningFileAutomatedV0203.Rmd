...
0. Setup experiment-specific configuration.
...
Chunk 1 should be run when the sign-up file is complete

Parameters to set:

- Manager login information: "account|email", "password"  (already set)
